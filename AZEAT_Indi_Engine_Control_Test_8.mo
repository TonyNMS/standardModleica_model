model AZEAT_Indi_Engine_Control_Test_8
  //=============
...
// before going into the loop, set the unmet to P_net for the first generartor
    ...
    /*
                        ...
                        */
    Modelica.Blocks.Sources.RealExpression PowertrainChargingPwr(y = individualControllerCore8.P_batt_charge_request) annotation(
  ...
  IndividualEngineController.IndividualControllerCore8 individualControllerCore8(
                                gen_1_exist = controller_gen_1_exist, gen_2_exist = controller_gen_2_exist, 
                                gen_3_exist = controller_gen_3_exist, gen_4_exist = controller_gen_4_exist, 
                                gen_5_exist = controller_gen_5_exist, gen_6_exist = controller_gen_6_exist, 
                                gen_7_exist = controller_gen_7_exist, gen_8_exist = controller_gen_8_exist, 
      ...
      Placement(transformation(origin = {-25.0769, 35.0769}, extent = {{-44.9231, -48.6667}, {44.9231, 48.6667}})));
  equation
  ...
  connect(gen_1_controller_optim_upper, individualControllerCore8.P_gen_1_Optim_Upper) annotation(
      Line(points = {{-110, 90}, {-86, 90}, {-86, 69}, {-66, 69}}, color = {0, 0, 127}));
  connect(gen_1_controller_optim_lower, individualControllerCore8.P_gen_1_Optim_Lower) annotation(
      Line(points = {{-110, 70}, {-90, 70}, {-90, 61}, {-66, 61}}, color = {0, 0, 127}));
  connect(gen_2_controller_optim_upper, individualControllerCore8.P_gen_2_Optim_Upper) annotation(
      Line(points = {{-110, 50}, {-82, 50}, {-82, 54}, {-66, 54}}, color = {0, 0, 127}));
  connect(gen_2_controller_optim_lower, individualControllerCore8.P_gen_2_Optim_Lower) annotation(
      Line(points = {{-110, 30}, {-90, 30}, {-90, 46}, {-66, 46}}, color = {0, 0, 127}));
  connect(gen_3_controller_optim_upper, individualControllerCore8.P_gen_3_Optim_Upper) annotation(
      Line(points = {{-110, 10}, {-86, 10}, {-86, 39}, {-66, 39}}, color = {0, 0, 127}));
  connect(gen_3_controller_optim_lower, individualControllerCore8.P_gen_3_Optim_Lower) annotation(
      Line(points = {{-110, -10}, {-82, -10}, {-82, 31}, {-66, 31}}, color = {0, 0, 127}));
  connect(gen_4_controller_optim_upper, individualControllerCore8.P_gen_4_Optim_Upper) annotation(
      Line(points = {{-110, -30}, {-90, -30}, {-90, 24}, {-66, 24}}, color = {0, 0, 127}));
  connect(gen_4_controller_optim_lower, individualControllerCore8.P_gen_4_Optim_Lower) annotation(
      Line(points = {{-110, -50}, {-94, -50}, {-94, 16}, {-66, 16}}, color = {0, 0, 127}));
  connect(gen_5_controller_optim_upper, individualControllerCore8.P_gen_5_Optim_Upper) annotation(
      Line(points = {{-110, -70}, {-84, -70}, {-84, 9}, {-66, 9}}, color = {0, 0, 127}));
  connect(gen_5_controller_optim_lower, individualControllerCore8.P_gen_5_Optim_Lower) annotation(
      Line(points = {{-110, -90}, {-86, -90}, {-86, 1}, {-66, 1}}, color = {0, 0, 127}));
  connect(individualControllerCore8.P_load_1, P_load_1) annotation(
      Line(points = {{-58, -6}, {-58, -64}, {-66, -64}, {-66, -114}}, color = {0, 0, 127}));
  connect(SOC_1, individualControllerCore8.SOC_1) annotation(
      Line(points = {{-92, -120}, {-92, -76}, {-51, -76}, {-51, -6}}, color = {0, 0, 127}));
  connect(gen_6_controller_optim_upper, individualControllerCore8.P_gen_6_Optim_Upper) annotation(
      Line(points = {{-90, 110}, {-90, 90}, {-59, 90}, {-59, 76}}, color = {0, 0, 127}));
  connect(gen_6_controller_optim_lower, individualControllerCore8.P_gen_6_Optim_Lower) annotation(
      Line(points = {{-70, 110}, {-70, 86}, {-51, 86}, {-51, 76}}, color = {0, 0, 127}));
  connect(gen_7_controller_optim_upper, individualControllerCore8.P_gen_7_Optim_Upper) annotation(
      Line(points = {{-50, 110}, {-50, 88}, {-44, 88}, {-44, 76}}, color = {0, 0, 127}));
  connect(gen_7_controller_optim_lower, individualControllerCore8.P_gen_7_Optim_Lower) annotation(
      Line(points = {{-30, 110}, {-30, 92}, {-36, 92}, {-36, 76}}, color = {0, 0, 127}));
  connect(gen_8_controller_optim_upper, individualControllerCore8.P_gen_8_Optim_Upper) annotation(
      Line(points = {{-10, 110}, {-10, 92}, {-29, 92}, {-29, 76}}, color = {0, 0, 127}));
  connect(gen_8_controller_optim_lower, individualControllerCore8.P_gen_8_Optim_Lower) annotation(
      Line(points = {{10, 110}, {10, 88}, {-21, 88}, {-21, 76}}, color = {0, 0, 127}));
  connect(gen_9_controller_optim_upper, individualControllerCore8.P_gen_9_Optim_Upper) annotation(
      Line(points = {{30, 110}, {30, 90}, {-14, 90}, {-14, 76}}, color = {0, 0, 127}));
  connect(gen_9_controller_optim_lower, individualControllerCore8.P_gen_9_Optim_Lower) annotation(
      Line(points = {{50, 110}, {50, 86}, {-6, 86}, {-6, 76}}, color = {0, 0, 127}));
  connect(gen_10_controller_optim_upper, individualControllerCore8.P_gen_10_Optim_Upper) annotation(
      Line(points = {{70, 110}, {70, 84}, {1, 84}, {1, 76}}, color = {0, 0, 127}));
  connect(gen_10_controller_optim_lower, individualControllerCore8.P_gen_10_Optim_Lower) annotation(
      Line(points = {{90, 110}, {88, 110}, {88, 76}, {9, 76}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen1_output, generator_1_controller_output) annotation(
      Line(points = {{16, 69}, {62, 69}, {62, 90}, {110, 90}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen2_output, generator_2_controller_output) annotation(
      Line(points = {{16, 61}, {76, 61}, {76, 70}, {110, 70}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen3_output, generator_3_controller_output) annotation(
      Line(points = {{16, 54}, {56, 54}, {56, 50}, {110, 50}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen4_output, generator_4_controller_output) annotation(
      Line(points = {{16, 46}, {48, 46}, {48, 30}, {110, 30}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen5_output, generator_5_controller_output) annotation(
      Line(points = {{16, 39}, {68, 39}, {68, 10}, {110, 10}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen6_output, generator_6_controller_output) annotation(
      Line(points = {{16, 31}, {64, 31}, {64, -10}, {110, -10}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen7_output, generator_7_controller_output) annotation(
      Line(points = {{16, 24}, {60, 24}, {60, -32}, {110, -32}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen8_output, generator_8_controller_output) annotation(
      Line(points = {{16, 16}, {62, 16}, {62, -50}, {110, -50}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen9_output, generator_9_controller_output) annotation(
      Line(points = {{16, 9}, {58, 9}, {58, -70}, {110, -70}}, color = {0, 0, 127}));
  connect(individualControllerCore8.gen10_output, generator_10_controller_output) annotation(
      Line(points = {{16, 1}, {72, 1}, {72, -90}, {110, -90}}, color = {0, 0, 127}));
  connect(individualControllerCore8.P_battery_1, gainCharingMin.u) annotation(
      Line(points = {{16, -6}, {24, -6}, {24, -4}, {30, -4}}, color = {0, 0, 127}));
  connect(genMinBSFC1, individualControllerCore8.genMostEffPwr1) annotation(
      Line(points = {{-50, -106}, {-50, -76}, {-38, -76}, {-38, -18}, {-29, -18}, {-29, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC2, individualControllerCore8.genMostEffPwr2) annotation(
      Line(points = {{-42, -106}, {-42, -46}, {-25, -46}, {-25, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC3, individualControllerCore8.genMostEffPwr3) annotation(
      Line(points = {{-34, -106}, {-34, -34}, {-21, -34}, {-21, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC4, individualControllerCore8.genMostEffPwr4) annotation(
      Line(points = {{-26, -106}, {-26, -40}, {-18, -40}, {-18, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC5, individualControllerCore8.genMostEffPwr5) annotation(
      Line(points = {{-18, -106}, {-18, -42}, {-14, -42}, {-14, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC6, individualControllerCore8.genMostEffPwr6) annotation(
      Line(points = {{-10, -106}, {-10, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC7, individualControllerCore8.genMostEffPwr7) annotation(
      Line(points = {{-2, -106}, {-2, -54.5}, {-6, -54.5}, {-6, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC8, individualControllerCore8.genMostEffPwr8) annotation(
      Line(points = {{6, -106}, {6, -84}, {-6, -84}, {-6, -24}, {-3, -24}, {-3, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC9, individualControllerCore8.genMostEffPwr9) annotation(
      Line(points = {{14, -106}, {14, -88}, {-8, -88}, {-8, -14}, {1, -14}, {1, -5}}, color = {0, 0, 127}));
  connect(genMinBSFC10, individualControllerCore8.genMostEffPwr10) annotation(
      Line(points = {{22, -106}, {22, -96}, {-4, -96}, {-4, -28}, {2, -28}, {2, -18}, {5, -18}, {5, -5}}, color = {0, 0, 127}));
    annotation(
      Diagram,
  ...
  model IdealTankSinglePort
    ...
    model TriplePortTank
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_8.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_8.Fuel.SimpleFuel "Transported medium";
      ...
      /*Fuel*/
      //Fuel model will be referenced From AZEAT_Indi_Engine_Control_Test_8
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_8.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_8.Fuel.Templates.SimpleFuel "Transported medium" annotation(
         choicesAllMatching);
...
// Find how many units are required to run
  ...
  package Fuel
    ...
    package compressedhydrogen
      extends AZEAT_Indi_Engine_Control_Test_8.Fuel.MethanolFuel(LHV = 120e6, rho = 26, rho_liq = 26, MolarMass = 1.00899e-3, Delta_h_evap = 2.01588*1e-3);
  ...
  model Generator
    ...
    model Generator_Base
      ...
      replaceable package Fuel = AZEAT_Indi_Engine_Control_Test_8.Fuel.Diesel constrainedby AZEAT_Indi_Engine_Control_Test_8.Fuel.SimpleFuel "Fuel type" annotation(
         choicesAllMatching,
      ...
      FluidPort co2_outlet(redeclare package Medium = AZEAT_Indi_Engine_Control_Test_8.Fuel.CarbonDioxide, m_flow = -m_flow_CO2) if use_external_co2_sink annotation(
        Placement(transformation(extent = {{-10.0, -110.0}, {10.0, -90.0}}, rotation = 0.0, origin = {0.0, 0.0})));
    protected
...
// for mathematical stability , if constant efficiency is used this variable is not used in computation but it should be assigned with something for numerical balance
  ...
  model Tank "Tank model for gas storage"
    ...
    partial model Tank_base
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_8.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_8Fuel.Templates.SimpleFuel "Transported medium";
        Modelica.Units.SI.Pressure p "Pressure";
        flow Modelica.Units.SI.MassFlowRate m_flow "Mass flow rate";
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_8.Fuel.compressedhydrogen "Transported Medium" annotation(
        choicesAllMatching);
    ...
    //EndRepositroy
    extends Tank_base(E_store = energyDensity_max*V, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_8.Fuel.compressedhydrogen constrainedby AZEAT_Indi_Engine_Control_Test_8.Fuel.Templates.SimpleFuel);
    //Local Parameters
...
// Connectors
  ...
  model FuelCellEfficiency
    partial model Base
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_8.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_8.Fuel.Hydrogen "Transported medium" annotation(
         choicesAllMatching);
...
// Summary
  ...
  parameter Real mCtrl_user_defined_upper_bound_diesel_1 = 700;
  ...
  parameter Real mCtrl_user_defined_upper_bound_diesel_2 = 700;
  ...
  parameter Real BSFC_Curve_1[:, 2] = [80, 180.80; 160, 172.11; 240, 167.23; 320, 163.85; 400, 161.27; 480, 159.20; 560, 157.47; 640, 155.98; 720, 154.68; 800, 153.53];
  ...
  // Part Battery
  AZEAT_Indi_Engine_Control_Test_8.BatteryDualControl battery1(eff_charge = battery_Eff_Charge, set_SOC_final_start_ = battery_Set_SOC_Final_Start, SOC_max = mCtrl_SOC_max, SOC_min = mCtrl_SOC_min, capacity = battery_Capacity, P_max = battery_P_max, SOC_start = battery_SOC_start) annotation(
    Placement(transformation(origin = {-60, -138}, extent = {{-18, -18}, {18, 18}})));
  // Part Electrical Untitlity
  AZEAT_Indi_Engine_Control_Test_8.Converter_ACDC converter_ACDC(efficiency = 1, V_ref_DC = 1, power_nominal = P_nominal, P_max = 10*P_nominal) "Inverter" annotation(
    Placement(transformation(origin = {144, -222}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_8.ElectricalGrid electricalGrid(power_nominal = P_nominal, V_ref = 1000) annotation(
    Placement(transformation(origin = {192, -224}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_8.ElectricLoad electricLoad(use_input = true, load_in = 1000) annotation(
    Placement(transformation(origin = {167, -201}, extent = {{11, -11}, {-11, 11}})));
  AZEAT_Indi_Engine_Control_Test_8.Transformer transformer(efficiency = 1, power_nominal = P_nominal, P_max = 10*P_nominal) annotation(
  ...
  // Part Controller
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(tableOnFile = true, tableName = "tab1", fileName = "C:/Users/NMS08/Desktop/ReCreatedModel/AZETValidationCase/2024-04_FC_Cardinal_buoy_maintenance Adjusted Max.txt", verboseRead = true, columns = 2:2) annotation(
    Placement(transformation(origin = {230, -274}, extent = {{10, -10}, {-10, 10}})));
  ...
  AZEAT_Indi_Engine_Control_Test_8.FuelUsageTrapezoidSampled fuelUsageTrapezoidSampled annotation(
...
equation
  ...
  connect(time_expre2.y, combiTable1Ds.u) annotation(
    Line(points = {{295, -276}, {267, -276}, {267, -274}, {242, -274}}, color = {0, 0, 127}));
  connect(combiTable1Ds.y[1], gain1.u) annotation(
    Line(points = {{219, -274}, {173, -274}, {173, -276}, {171, -276}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end AZEAT_Indi_Engine_Control_Test_8;
