model AZEAT_Indi_Engine_Control_Test_5
  //=============
 ...
 //=============
  ...
  // External Model Repository for Local AZEAT_Indi_Engine_Control_Test_5 Use
  ...
  annotation(
    ...
    if isLast then
            if useBattery then
              ...
              yCand := pMax; // this is the last generator, work as hard as possible
              tempNode := 4.1;
            end if;
          else
            if useBattery then
...
// before going into the loop, set the unmet to P_net for the first generartor
  ...
  /*
                    ...
                    */
    Modelica.Blocks.Sources.RealExpression PowertrainChargingPwr(y = individualControllerCore5.P_batt_charge_request) annotation(
  ...
  IndividualEngineController.IndividualControllerCore5 individualControllerCore5(
                    gen_1_exist = controller_gen_1_exist, gen_2_exist = controller_gen_2_exist, 
                            gen_3_exist = controller_gen_3_exist, gen_4_exist = controller_gen_4_exist, 
                            gen_5_exist = controller_gen_5_exist, gen_6_exist = controller_gen_6_exist, 
                            gen_7_exist = controller_gen_7_exist, gen_8_exist = controller_gen_8_exist, 
      ...
      Placement(transformation(origin = {-36.6154, 42.7692}, extent = {{-39.2308, -42.5}, {39.2308, 42.5}})));
  equation
 ...
 connect(gen_1_controller_optim_upper, individualControllerCore5.P_gen_1_Optim_Upper) annotation(
      Line(points = {{-110, 90}, {-86, 90}, {-86, 72}, {-73, 72}}, color = {0, 0, 127}));
 connect(gen_1_controller_optim_lower, individualControllerCore5.P_gen_1_Optim_Lower) annotation(
      Line(points = {{-110, 70}, {-92, 70}, {-92, 66}, {-73, 66}}, color = {0, 0, 127}));
 connect(gen_2_controller_optim_upper, individualControllerCore5.P_gen_2_Optim_Upper) annotation(
      Line(points = {{-110, 50}, {-90, 50}, {-90, 59}, {-73, 59}}, color = {0, 0, 127}));
 connect(gen_2_controller_optim_lower, individualControllerCore5.P_gen_2_Optim_Lower) annotation(
      Line(points = {{-110, 30}, {-90, 30}, {-90, 53}, {-73, 53}}, color = {0, 0, 127}));
 connect(gen_3_controller_optim_upper, individualControllerCore5.P_gen_3_Optim_Upper) annotation(
      Line(points = {{-110, 10}, {-86, 10}, {-86, 46}, {-73, 46}}, color = {0, 0, 127}));
 connect(gen_3_controller_optim_lower, individualControllerCore5.P_gen_3_Optim_Lower) annotation(
      Line(points = {{-110, -10}, {-92, -10}, {-92, 39}, {-73, 39}}, color = {0, 0, 127}));
 connect(gen_4_controller_optim_upper, individualControllerCore5.P_gen_4_Optim_Upper) annotation(
      Line(points = {{-110, -30}, {-88, -30}, {-88, 33}, {-73, 33}}, color = {0, 0, 127}));
 connect(gen_4_controller_optim_lower, individualControllerCore5.P_gen_4_Optim_Lower) annotation(
      Line(points = {{-110, -50}, {-84, -50}, {-84, 26}, {-73, 26}}, color = {0, 0, 127}));
 connect(gen_5_controller_optim_upper, individualControllerCore5.P_gen_5_Optim_Upper) annotation(
      Line(points = {{-110, -70}, {-82, -70}, {-82, 20}, {-73, 20}}, color = {0, 0, 127}));
 connect(gen_5_controller_optim_lower, individualControllerCore5.P_gen_5_Optim_Lower) annotation(
      Line(points = {{-110, -90}, {-96, -90}, {-96, 13}, {-73, 13}}, color = {0, 0, 127}));
 connect(genMinBSFC1, individualControllerCore5.genMostEffPwr1) annotation(
      Line(points = {{-50, -106}, {-48, -106}, {-48, -3}, {-40, -3}, {-40, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC2, individualControllerCore5.genMostEffPwr2) annotation(
      Line(points = {{-42, -106}, {-42, -6}, {-37, -6}, {-37, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC3, individualControllerCore5.genMostEffPwr3) annotation(
      Line(points = {{-34, -106}, {-38, -106}, {-38, -9}, {-33, -9}, {-33, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC4, individualControllerCore5.genMostEffPwr4) annotation(
      Line(points = {{-26, -106}, {-28, -106}, {-28, -1}, {-30, -1}, {-30, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC5, individualControllerCore5.genMostEffPwr5) annotation(
      Line(points = {{-18, -106}, {-18, -12}, {-27, -12}, {-27, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC6, individualControllerCore5.genMostEffPwr6) annotation(
      Line(points = {{-10, -106}, {-10, -4}, {-24, -4}, {-24, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC7, individualControllerCore5.genMostEffPwr7) annotation(
      Line(points = {{-2, -106}, {-2, -82}, {-20, -82}, {-20, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC8, individualControllerCore5.genMostEffPwr8) annotation(
      Line(points = {{6, -106}, {6, -70}, {-17, -70}, {-17, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC9, individualControllerCore5.genMostEffPwr9) annotation(
      Line(points = {{14, -106}, {14, -78}, {-14, -78}, {-14, 8}}, color = {0, 0, 127}));
 connect(genMinBSFC10, individualControllerCore5.genMostEffPwr10) annotation(
      Line(points = {{22, -106}, {22, -84}, {-10, -84}, {-10, 8}}, color = {0, 0, 127}));
 connect(gen_6_controller_optim_upper, individualControllerCore5.P_gen_6_Optim_Upper) annotation(
      Line(points = {{-90, 110}, {-90, 90}, {-66, 90}, {-66, 79}}, color = {0, 0, 127}));
 connect(gen_6_controller_optim_lower, individualControllerCore5.P_gen_6_Optim_Lower) annotation(
      Line(points = {{-70, 110}, {-72, 110}, {-72, 79}, {-60, 79}}, color = {0, 0, 127}));
 connect(gen_7_controller_optim_upper, individualControllerCore5.P_gen_7_Optim_Upper) annotation(
      Line(points = {{-50, 110}, {-50, 90}, {-53, 90}, {-53, 79}}, color = {0, 0, 127}));
 connect(gen_7_controller_optim_lower, individualControllerCore5.P_gen_7_Optim_Lower) annotation(
      Line(points = {{-30, 110}, {-30, 92}, {-46, 92}, {-46, 79}}, color = {0, 0, 127}));
 connect(gen_8_controller_optim_upper, individualControllerCore5.P_gen_8_Optim_Upper) annotation(
      Line(points = {{-10, 110}, {-10, 88}, {-40, 88}, {-40, 79}}, color = {0, 0, 127}));
 connect(gen_8_controller_optim_lower, individualControllerCore5.P_gen_8_Optim_Lower) annotation(
      Line(points = {{10, 110}, {10, 90}, {-33, 90}, {-33, 79}}, color = {0, 0, 127}));
 connect(gen_9_controller_optim_upper, individualControllerCore5.P_gen_9_Optim_Upper) annotation(
      Line(points = {{30, 110}, {30, 86}, {-27, 86}, {-27, 79}}, color = {0, 0, 127}));
 connect(gen_9_controller_optim_lower, individualControllerCore5.P_gen_9_Optim_Lower) annotation(
      Line(points = {{50, 110}, {48, 110}, {48, 95}, {-20, 95}, {-20, 79}}, color = {0, 0, 127}));
 connect(gen_10_controller_optim_upper, individualControllerCore5.P_gen_10_Optim_Upper) annotation(
      Line(points = {{70, 110}, {68, 110}, {68, 89}, {-14, 89}, {-14, 79}}, color = {0, 0, 127}));
 connect(gen_10_controller_optim_lower, individualControllerCore5.P_gen_10_Optim_Lower) annotation(
      Line(points = {{90, 110}, {90, 84}, {-7, 84}, {-7, 79}}, color = {0, 0, 127}));
 connect(individualControllerCore5.P_battery_1, gainCharingMin.u) annotation(
      Line(points = {{-1, 7}, {4, 7}, {4, -6}, {16, -6}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen1_output, generator_1_controller_output) annotation(
      Line(points = {{-1, 72}, {48, 72}, {48, 90}, {110, 90}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen2_output, generator_2_controller_output) annotation(
      Line(points = {{-1, 66}, {58, 66}, {58, 70}, {110, 70}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen3_output, generator_3_controller_output) annotation(
      Line(points = {{-1, 59}, {62, 59}, {62, 50}, {110, 50}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen4_output, generator_4_controller_output) annotation(
      Line(points = {{-1, 53}, {48, 53}, {48, 30}, {110, 30}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen5_output, generator_5_controller_output) annotation(
      Line(points = {{-1, 46}, {36, 46}, {36, 10}, {110, 10}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen6_output, generator_6_controller_output) annotation(
      Line(points = {{-1, 39}, {-1, -12}, {110, -12}, {110, -10}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen7_output, generator_7_controller_output) annotation(
      Line(points = {{-1, 33}, {42, 33}, {42, 4}, {72, 4}, {72, -32}, {110, -32}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen8_output, generator_8_controller_output) annotation(
      Line(points = {{-1, 26}, {62, 26}, {62, -50}, {110, -50}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen9_output, generator_9_controller_output) annotation(
      Line(points = {{-1, 20}, {56, 20}, {56, -70}, {110, -70}}, color = {0, 0, 127}));
 connect(individualControllerCore5.gen10_output, generator_10_controller_output) annotation(
      Line(points = {{-1, 13}, {34, 13}, {34, 0}, {78, 0}, {78, -90}, {110, -90}}, color = {0, 0, 127}));
 connect(P_load_1, individualControllerCore5.P_load_1) annotation(
      Line(points = {{-66, -114}, {-66, 6}}, color = {0, 0, 127}));
 connect(SOC_1, individualControllerCore5.SOC_1) annotation(
      Line(points = {{-92, -120}, {-92, -42}, {-58, -42}, {-58, 6}}, color = {0, 0, 127}));
    annotation(
      Diagram,
  ...
  model IdealTankSinglePort
    ...
    model TriplePortTank
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_5.Fuel.SimpleFuel "Transported medium";
      ...
      /*Fuel*/
      //Fuel model will be referenced From AZEAT_Indi_Engine_Control_Test_5
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_5.Fuel.Templates.SimpleFuel "Transported medium" annotation(
         choicesAllMatching);
...
// Find how many units are required to run
  ...
  package Fuel
    ...
    package compressedhydrogen
      extends AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel(LHV = 120e6, rho = 26, rho_liq = 26, MolarMass = 1.00899e-3, Delta_h_evap = 2.01588*1e-3);
  ...
  model Generator
    ...
    model Generator_Base
      ...
      replaceable package Fuel = AZEAT_Indi_Engine_Control_Test_5.Fuel.Diesel constrainedby AZEAT_Indi_Engine_Control_Test_5.Fuel.SimpleFuel "Fuel type" annotation(
         choicesAllMatching,
      ...
      FluidPort co2_outlet(redeclare package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.CarbonDioxide, m_flow = -m_flow_CO2) if use_external_co2_sink annotation(
        Placement(transformation(extent = {{-10.0, -110.0}, {10.0, -90.0}}, rotation = 0.0, origin = {0.0, 0.0})));
    protected
...
// for mathematical stability , if constant efficiency is used this variable is not used in computation but it should be assigned with something for numerical balance
  ...
  model Tank "Tank model for gas storage"
    ...
    partial model Tank_base
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_5Fuel.Templates.SimpleFuel "Transported medium";
        Modelica.Units.SI.Pressure p "Pressure";
        flow Modelica.Units.SI.MassFlowRate m_flow "Mass flow rate";
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.compressedhydrogen "Transported Medium" annotation(
        choicesAllMatching);
    ...
    //EndRepositroy
    extends Tank_base(E_store = energyDensity_max*V, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.compressedhydrogen constrainedby AZEAT_Indi_Engine_Control_Test_5.Fuel.Templates.SimpleFuel);
    //Local Parameters
...
// Connectors
  ...
  model FuelCellEfficiency
    partial model Base
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_5.Fuel.Hydrogen "Transported medium" annotation(
         choicesAllMatching);
...
//fuel parameter Generator_Fuel GEN 3
  ...
  /*ENGINE PARAMETER*/
  parameter Real generator_P_rat_1 = 814000;
  parameter Real generator_P_rat_2 = 814000;
  ...
  parameter Real battery_Capacity = 2.239e+8  * 10  ;
  parameter Real battery_P_max = 93240 * 10  ; //93240
  ...
  parameter Real BSFC_Curve_1[:, 2] = [80, 197.91; 160, 189.97; 240, 183.23; 320, 177.71; 400, 173.40; 480, 170.30; 560, 168.42; 640, 167.74; 720, 168.28; 814, 170.03];
  ...
  // Part Battery
  AZEAT_Indi_Engine_Control_Test_5.BatteryDualControl battery1(eff_charge = battery_Eff_Charge, set_SOC_final_start_ = battery_Set_SOC_Final_Start, SOC_max = mCtrl_SOC_max, SOC_min = mCtrl_SOC_min, capacity = battery_Capacity, P_max = battery_P_max, SOC_start = battery_SOC_start) annotation(
    Placement(transformation(origin = {-60, -138}, extent = {{-18, -18}, {18, 18}})));
  // Part Electrical Untitlity
  AZEAT_Indi_Engine_Control_Test_5.Converter_ACDC converter_ACDC(efficiency = 1, V_ref_DC = 1, power_nominal = P_nominal, P_max = 10*P_nominal) "Inverter" annotation(
    Placement(transformation(origin = {144, -222}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.ElectricalGrid electricalGrid(power_nominal = P_nominal, V_ref = 1000) annotation(
    Placement(transformation(origin = {192, -224}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.ElectricLoad electricLoad(use_input = true, load_in = 1000) annotation(
    Placement(transformation(origin = {167, -201}, extent = {{11, -11}, {-11, 11}})));
  AZEAT_Indi_Engine_Control_Test_5.Transformer transformer(efficiency = 1, power_nominal = P_nominal, P_max = 10*P_nominal) annotation(
  ...
  AZEAT_Indi_Engine_Control_Test_5.IndividualEngineController individualEngineController(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator1(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator2(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator3(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator4(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator5(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator6(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator7(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator8(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator9(
  ...
  AZEAT_Indi_Engine_Control_Test_5.Generator generator10(
  ...
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort1(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 270}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort2(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 230}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort3(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 190}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort4(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 150}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort5(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 110}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort6(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, 30}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort7(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -10}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort8(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -50}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort9(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -90}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_5.IdealTankSinglePort idealTankSinglePort10(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_5.Fuel.MethanolFuel)  annotation(
  ...
  Modelica.Blocks.Sources.RealExpression genFuelFlow10(y = if gen10_is_on then generator10.outlet_fuel.m_flow else 0) annotation(
   ...
   Modelica.Blocks.Sources.RealExpression Surplus(y= (((if gen1_is_on then generator1.P_out else 0) + (if gen2_is_on then generator2.P_out else 0) + (if gen3_is_on then generator3.P_out else 0) +
      ...
      )+(if battery_P_max> 1 then battery1.P_out * (-1) else 0 )-(gain1.y))) annotation(
 ...
 AZEAT_Indi_Engine_Control_Test_5.FuelUsageTrapezoidSampled fuelUsageTrapezoidSampled annotation(
 ...
 Modelica.Blocks.Interaction.Show.RealValue realValueSurplusIntergal annotation(
 ...
 Modelica.Blocks.Interaction.Show.RealValue realValueTotalEnergy annotation(
 ...
 Modelica.Blocks.Sources.RealExpression realExpressionController_P_Charge_1(y = individualEngineController.P_charge_1*battery_P_max)  annotation(
    Placement(transformation(origin = {-70, -374}, extent = {{-10, -10}, {10, 10}})));
 ...
 Modelica.Blocks.Interaction.Show.RealValue realValueTotalEnergy1 annotation(
 ...
 Modelica.Blocks.Math.Division division annotation(
    Placement(transformation(origin = {-284, -500}, extent = {{-10, -10}, {10, 10}})));
 Modelica.Blocks.Interaction.Show.RealValue realValueTotalEnerguBatteryDischarge annotation(
    Placement(transformation(origin = {-236, -488}, extent = {{-10, -10}, {10, 10}}))); initial equation
    fuelUsage1 = 0;
    fuelUsage2 = 0;
    fuelUsage3 = 0;
    fuelUsage4 = 0;
 ...
 connect(realExpressionController_P_Charge_1.y, contoller_charing_output.numberPort) annotation(
    Line(points = {{-59, -374}, {-5, -374}}, color = {0, 0, 127}));
 ...
 connect(divisionSurplusJ2kWh.y, realValueSurplusIntergal.numberPort) annotation(
    Line(points = {{-265, -358}, {-248.5, -358}}, color = {0, 0, 127}));
 connect(divisiontotalEnergyProvidedJ2kWh.y, realValueTotalEnergy.numberPort) annotation(
 ...
 connect(divisiontotalEnergyProvidedJ2kWh1.y, realValueTotalEnergy1.numberPort) annotation(
 ...
 connect(integrator.y, division.u1) annotation(
    Line(points = {{-324, -492}, {-306, -492}, {-306, -494}, {-296, -494}}, color = {0, 0, 127}));
 connect(division.y, realValueTotalEnerguBatteryDischarge.numberPort) annotation(
    Line(points = {{-272, -500}, {-262, -500}, {-262, -488}, {-248, -488}}, color = {0, 0, 127}));
 connect(realExpressionJ2kWh.y, division.u2) annotation(
    Line(points = {{-308, -430}, {-308, -506}, {-296, -506}}, color = {0, 0, 127}));
  annotation(
    ...
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end AZEAT_Indi_Engine_Control_Test_5;
