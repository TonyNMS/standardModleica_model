model AZEAT_Indi_Engine_Control_Test_6
  //=============
 ...
 //=============
  ...
  // External Model Repository for Local AZEAT_Indi_Engine_Control_Test_6 Use
  ...
  // Modified the controllor so that geneator checks the chargin limit of the battery before commit charging.(this is to eliminate wasted energy)
  /*Master Controller*/
 ...
 Modelica.Blocks.Interfaces.RealOutput y annotation(
  ...
  annotation(
    ...
    model IndividualControllerCore7
     ...
     /*Geneartor  now can goes to pEff to charge the battery if, the battery charign liomit is greater than the surplus (when demand is below lower bound*/
...
// before going into the loop, set the unmet to P_net for the first generartor
  ...
  /*
                    ...
                    */
    Modelica.Blocks.Sources.RealExpression PowertrainChargingPwr(y = individualControllerCore6.P_batt_charge_request) annotation(
 ...
 IndividualEngineController.IndividualControllerCore6 individualControllerCore6(
    gen_1_exist = controller_gen_1_exist, gen_2_exist = controller_gen_2_exist, 
                            gen_3_exist = controller_gen_3_exist, gen_4_exist = controller_gen_4_exist, 
                            gen_5_exist = controller_gen_5_exist, gen_6_exist = controller_gen_6_exist, 
                            gen_7_exist = controller_gen_7_exist, gen_8_exist = controller_gen_8_exist, 
      ...
      Placement(transformation(origin = {-29.1538, 47.1538}, extent = {{-36.8462, -39.9167}, {36.8462, 39.9167}})));
  equation
 ...
 connect(gen_1_controller_optim_upper, individualControllerCore6.P_gen_1_Optim_Upper) annotation(
      Line(points = {{-110, 90}, {-92, 90}, {-92, 75}, {-63, 75}}, color = {0, 0, 127}));
 connect(gen_1_controller_optim_lower, individualControllerCore6.P_gen_1_Optim_Lower) annotation(
      Line(points = {{-110, 70}, {-86, 70}, {-86, 69}, {-63, 69}}, color = {0, 0, 127}));
 connect(gen_2_controller_optim_upper, individualControllerCore6.P_gen_2_Optim_Upper) annotation(
      Line(points = {{-110, 50}, {-90, 50}, {-90, 63}, {-63, 63}}, color = {0, 0, 127}));
 connect(gen_2_controller_optim_lower, individualControllerCore6.P_gen_2_Optim_Lower) annotation(
      Line(points = {{-110, 30}, {-84, 30}, {-84, 56}, {-63, 56}}, color = {0, 0, 127}));
 connect(gen_3_controller_optim_upper, individualControllerCore6.P_gen_3_Optim_Upper) annotation(
      Line(points = {{-110, 10}, {-86, 10}, {-86, 50}, {-63, 50}}, color = {0, 0, 127}));
 connect(gen_3_controller_optim_lower, individualControllerCore6.P_gen_3_Optim_Lower) annotation(
      Line(points = {{-110, -10}, {-80, -10}, {-80, 44}, {-63, 44}}, color = {0, 0, 127}));
 connect(gen_4_controller_optim_upper, individualControllerCore6.P_gen_4_Optim_Upper) annotation(
      Line(points = {{-110, -30}, {-90, -30}, {-90, 38}, {-63, 38}}, color = {0, 0, 127}));
 connect(gen_4_controller_optim_lower, individualControllerCore6.P_gen_4_Optim_Lower) annotation(
      Line(points = {{-110, -50}, {-82, -50}, {-82, 32}, {-63, 32}}, color = {0, 0, 127}));
 connect(gen_5_controller_optim_upper, individualControllerCore6.P_gen_5_Optim_Upper) annotation(
      Line(points = {{-110, -70}, {-84, -70}, {-84, 26}, {-63, 26}}, color = {0, 0, 127}));
 connect(gen_5_controller_optim_lower, individualControllerCore6.P_gen_5_Optim_Lower) annotation(
      Line(points = {{-110, -90}, {-78, -90}, {-78, 20}, {-63, 20}}, color = {0, 0, 127}));
 connect(gen_6_controller_optim_upper, individualControllerCore6.P_gen_6_Optim_Upper) annotation(
      Line(points = {{-90, 110}, {-90, 92}, {-57, 92}, {-57, 81}}, color = {0, 0, 127}));
 connect(gen_6_controller_optim_lower, individualControllerCore6.P_gen_6_Optim_Lower) annotation(
      Line(points = {{-70, 110}, {-70, 94}, {-51, 94}, {-51, 81}}, color = {0, 0, 127}));
 connect(gen_7_controller_optim_upper, individualControllerCore6.P_gen_7_Optim_Upper) annotation(
      Line(points = {{-50, 110}, {-50, 96}, {-45, 96}, {-45, 81}}, color = {0, 0, 127}));
 connect(gen_7_controller_optim_lower, individualControllerCore6.P_gen_7_Optim_Lower) annotation(
      Line(points = {{-30, 110}, {-30, 94}, {-38, 94}, {-38, 81}}, color = {0, 0, 127}));
 connect(gen_8_controller_optim_upper, individualControllerCore6.P_gen_8_Optim_Upper) annotation(
      Line(points = {{-10, 110}, {-10, 92}, {-32, 92}, {-32, 81}}, color = {0, 0, 127}));
 connect(gen_8_controller_optim_lower, individualControllerCore6.P_gen_8_Optim_Lower) annotation(
      Line(points = {{10, 110}, {10, 90}, {-26, 90}, {-26, 81}}, color = {0, 0, 127}));
 connect(gen_9_controller_optim_upper, individualControllerCore6.P_gen_9_Optim_Upper) annotation(
      Line(points = {{30, 110}, {30, 96}, {-20, 96}, {-20, 81}}, color = {0, 0, 127}));
 connect(gen_9_controller_optim_lower, individualControllerCore6.P_gen_9_Optim_Lower) annotation(
      Line(points = {{50, 110}, {48, 110}, {48, 94}, {-14, 94}, {-14, 81}}, color = {0, 0, 127}));
 connect(gen_10_controller_optim_upper, individualControllerCore6.P_gen_10_Optim_Upper) annotation(
      Line(points = {{70, 110}, {70, 92}, {-8, 92}, {-8, 81}}, color = {0, 0, 127}));
 connect(gen_10_controller_optim_lower, individualControllerCore6.P_gen_10_Optim_Lower) annotation(
      Line(points = {{90, 110}, {90, 88}, {-2, 88}, {-2, 81}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen1_output, generator_1_controller_output) annotation(
      Line(points = {{5, 75}, {50, 75}, {50, 90}, {110, 90}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen2_output, generator_2_controller_output) annotation(
      Line(points = {{5, 69}, {52, 69}, {52, 70}, {110, 70}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen3_output, generator_3_controller_output) annotation(
      Line(points = {{5, 63}, {56, 63}, {56, 50}, {110, 50}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen4_output, generator_4_controller_output) annotation(
      Line(points = {{5, 56}, {72, 56}, {72, 30}, {110, 30}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen5_output, generator_5_controller_output) annotation(
      Line(points = {{5, 50}, {54, 50}, {54, 10}, {110, 10}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen6_output, generator_6_controller_output) annotation(
      Line(points = {{5, 44}, {48, 44}, {48, -10}, {110, -10}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen7_output, generator_7_controller_output) annotation(
      Line(points = {{5, 38}, {42, 38}, {42, -32}, {110, -32}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen8_output, generator_8_controller_output) annotation(
      Line(points = {{5, 32}, {40, 32}, {40, -50}, {110, -50}}, color = {0, 0, 127}));
 connect(individualControllerCore6.P_battery_1, gainCharingMin.u) annotation(
      Line(points = {{5, 13}, {8, 13}, {8, -6}, {16, -6}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen9_output, generator_9_controller_output) annotation(
      Line(points = {{5, 26}, {68, 26}, {68, -70}, {110, -70}}, color = {0, 0, 127}));
 connect(individualControllerCore6.gen10_output, generator_10_controller_output) annotation(
      Line(points = {{5, 20}, {60, 20}, {60, -90}, {110, -90}}, color = {0, 0, 127}));
 connect(individualControllerCore6.P_load_1, P_load_1) annotation(
      Line(points = {{-56, 13}, {-66, 13}, {-66, -114}}, color = {0, 0, 127}));
 connect(SOC_1, individualControllerCore6.SOC_1) annotation(
      Line(points = {{-92, -120}, {-92, -16}, {-50, -16}, {-50, 13}}, color = {0, 0, 127}));
 connect(genMinBSFC1, individualControllerCore6.genMostEffPwr1) annotation(
      Line(points = {{-50, -106}, {-50, -6}, {-32, -6}, {-32, 15}}, color = {0, 0, 127}));
 connect(genMinBSFC2, individualControllerCore6.genMostEffPwr2) annotation(
      Line(points = {{-42, -106}, {-42, 2}, {-30, 2}, {-30, 8}, {-29, 8}, {-29, 15}}, color = {0, 0, 127}));
 connect(genMinBSFC3, individualControllerCore6.genMostEffPwr3) annotation(
      Line(points = {{-34, -106}, {-32, -106}, {-32, 0}, {-26, 0}, {-26, 15}}, color = {0, 0, 127}));
 connect(genMinBSFC4, individualControllerCore6.genMostEffPwr4) annotation(
      Line(points = {{-26, -106}, {-26, -47}, {-23, -47}, {-23, 15}}, color = {0, 0, 127}));
 connect(genMinBSFC5, individualControllerCore6.genMostEffPwr5) annotation(
      Line(points = {{-18, -106}, {-18, -45.5}, {-20, -45.5}, {-20, 15}}, color = {0, 0, 127}));
 connect(genMinBSFC6, individualControllerCore6.genMostEffPwr6) annotation(
      Line(points = {{-10, -106}, {-10, -14}, {-20, -14}, {-20, 15}, {-17, 15}}, color = {0, 0, 127}));
 connect(genMinBSFC7, individualControllerCore6.genMostEffPwr7) annotation(
      Line(points = {{-2, -106}, {-2, -60}, {-14, -60}, {-14, 15}}, color = {0, 0, 127}));
 connect(genMinBSFC8, individualControllerCore6.genMostEffPwr8) annotation(
      Line(points = {{6, -106}, {6, -84}, {-11, -84}, {-11, 15}}, color = {0, 0, 127}));
 connect(individualControllerCore6.genMostEffPwr9, genMinBSFC9) annotation(
      Line(points = {{-8, 15}, {-8, -80}, {14, -80}, {14, -106}}, color = {0, 0, 127}));
 connect(genMinBSFC10, individualControllerCore6.genMostEffPwr10) annotation(
      Line(points = {{22, -106}, {22, -88}, {-4, -88}, {-4, 14}}, color = {0, 0, 127}));
    annotation(
      Diagram,
  ...
  model IdealTankSinglePort
    ...
    model TriplePortTank
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_6.Fuel.SimpleFuel "Transported medium";
      ...
      /*Fuel*/
      //Fuel model will be referenced From AZEAT_Indi_Engine_Control_Test_6
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_6.Fuel.Templates.SimpleFuel "Transported medium" annotation(
         choicesAllMatching);
...
// Find how many units are required to run
  ...
  package Fuel
    ...
    package compressedhydrogen
      extends AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel(LHV = 120e6, rho = 26, rho_liq = 26, MolarMass = 1.00899e-3, Delta_h_evap = 2.01588*1e-3);
  ...
  model Generator
    ...
    model Generator_Base
      ...
      replaceable package Fuel = AZEAT_Indi_Engine_Control_Test_6.Fuel.Diesel constrainedby AZEAT_Indi_Engine_Control_Test_6.Fuel.SimpleFuel "Fuel type" annotation(
         choicesAllMatching,
      ...
      FluidPort co2_outlet(redeclare package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.CarbonDioxide, m_flow = -m_flow_CO2) if use_external_co2_sink annotation(
        Placement(transformation(extent = {{-10.0, -110.0}, {10.0, -90.0}}, rotation = 0.0, origin = {0.0, 0.0})));
    protected
...
// for mathematical stability , if constant efficiency is used this variable is not used in computation but it should be assigned with something for numerical balance
  ...
  model Tank "Tank model for gas storage"
    ...
    partial model Tank_base
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_6Fuel.Templates.SimpleFuel "Transported medium";
        Modelica.Units.SI.Pressure p "Pressure";
        flow Modelica.Units.SI.MassFlowRate m_flow "Mass flow rate";
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.compressedhydrogen "Transported Medium" annotation(
        choicesAllMatching);
    ...
    //EndRepositroy
    extends Tank_base(E_store = energyDensity_max*V, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.compressedhydrogen constrainedby AZEAT_Indi_Engine_Control_Test_6.Fuel.Templates.SimpleFuel);
    //Local Parameters
...
// Connectors
  ...
  model FuelCellEfficiency
    partial model Base
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_6.Fuel.Hydrogen "Transported medium" annotation(
         choicesAllMatching);
...
//fuel parameter Generator_Fuel GEN 3
  ...
  // 850, 350
  parameter Real mCtrl_user_defined_upper_bound_diesel_1 = 900;
  parameter Real mCtrl_user_defined_lower_bound_diesel_1 = 200;
  parameter Real mCtrl_user_defined_BSFC_percentage_1 = 0.05;
  parameter Real mCtrl_user_defined_most_eff_ouput_1  = 750;
  ...
  parameter Real battery_Capacity = 2.239e+8  * 5;
  parameter Real battery_P_max =93240 * 5; //93240
  ...
  // Part Battery
  AZEAT_Indi_Engine_Control_Test_6.BatteryDualControl battery1(eff_charge = battery_Eff_Charge, set_SOC_final_start_ = battery_Set_SOC_Final_Start, SOC_max = mCtrl_SOC_max, SOC_min = mCtrl_SOC_min, capacity = battery_Capacity, P_max = battery_P_max, SOC_start = battery_SOC_start) annotation(
    Placement(transformation(origin = {-60, -138}, extent = {{-18, -18}, {18, 18}})));
  // Part Electrical Untitlity
  AZEAT_Indi_Engine_Control_Test_6.Converter_ACDC converter_ACDC(efficiency = 1, V_ref_DC = 1, power_nominal = P_nominal, P_max = 10*P_nominal) "Inverter" annotation(
    Placement(transformation(origin = {144, -222}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.ElectricalGrid electricalGrid(power_nominal = P_nominal, V_ref = 1000) annotation(
    Placement(transformation(origin = {192, -224}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.ElectricLoad electricLoad(use_input = true, load_in = 1000) annotation(
    Placement(transformation(origin = {167, -201}, extent = {{11, -11}, {-11, 11}})));
  AZEAT_Indi_Engine_Control_Test_6.Transformer transformer(efficiency = 1, power_nominal = P_nominal, P_max = 10*P_nominal) annotation(
  ...
  // Part Controller
  Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds(tableOnFile = true, tableName = "tab1", fileName = "C:/Users/NMS08/Desktop/ReCreatedModel/AZETValidationCase/2023-15 Multibeam sidescan Trimmed_Adjusted.txt", verboseRead = true, columns = 2:2) annotation(
    Placement(transformation(origin = {226, -272}, extent = {{10, -10}, {-10, 10}})));
  ...
  AZEAT_Indi_Engine_Control_Test_6.IndividualEngineController individualEngineController(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator1(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator2(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator3(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator4(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator5(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator6(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator7(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator8(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator9(
  ...
  AZEAT_Indi_Engine_Control_Test_6.Generator generator10(
  ...
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort1(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 270}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort2(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 230}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort3(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 190}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort4(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 150}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort5(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 110}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort6(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, 30}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort7(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -10}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort8(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -50}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort9(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -90}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_6.IdealTankSinglePort idealTankSinglePort10(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_6.Fuel.MethanolFuel)  annotation(
 ...
 AZEAT_Indi_Engine_Control_Test_6.FuelUsageTrapezoidSampled fuelUsageTrapezoidSampled annotation(
 ...
 equation
  ...
  connect(time_expre2.y, combiTable1Ds.u) annotation(
    Line(points = {{295, -276}, {267, -276}, {267, -272}, {238, -272}}, color = {0, 0, 127}));
  connect(combiTable1Ds.y[1], gain1.u) annotation(
    Line(points = {{215, -272}, {215, -276}, {171, -276}}, color = {0, 0, 127}));
 ...
 connect(realExpressionJ2kWh.y, division.u2) annotation(
  ...
  annotation(
    ...
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end AZEAT_Indi_Engine_Control_Test_6;
