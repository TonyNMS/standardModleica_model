model AZEAT_Indi_Engine_Control_Test
  //=============
  ...
  // External Model Repository for Local AZEAT_Indi_Engine_Control_Test Use
...
//---------------- Greedy pass across ALL generators ( in the model) ----------------
      for i in 1:N loop
        if gen_exist[i] then
          ...
          calculateGeneratorPower(current_engine_indx = i, last_active_engine_indx = lastActive, demand = P_rem[i], P_idle = P_idle[i], P_lo = P_opt_lo[i], P_eff =  P_most_eff[i],    P_hi = P_opt_hi[i], P_max = P_rated[i], useBattery = batteryInstalled, Battery_Capability = P_cap_now, batteryNeedsCharging = batNeedsCharging);
        else
          P_gen_cmd[i] = 0;
          P_bat_each[i] = 0;
...
// before going into the loop, set the unmet to P_net for the first generartor
  ...
  IndividualEngineController.IndividualControllerCore3 individualControllerCore3(
      ...
      Placement(transformation(origin = {-37.1538, 44.9872}, extent = {{-36.8462, -39.9167}, {36.8462, 39.9167}})));
  equation
  ...
  model IdealTankSinglePort
    ...
    model TriplePortTank
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test.Fuel.SimpleFuel "Transported medium";
      ...
      /*Fuel*/
      //Fuel model will be referenced From AZEAT_Indi_Engine_Control_Test
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test.Fuel.Templates.SimpleFuel "Transported medium" annotation(
         choicesAllMatching);
...
// Find how many units are required to run
  ...
  package Fuel
    ...
    package compressedhydrogen
      extends AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel(LHV = 120e6, rho = 26, rho_liq = 26, MolarMass = 1.00899e-3, Delta_h_evap = 2.01588*1e-3);
  ...
  model Generator
    ...
    model Generator_Base
      ...
      replaceable package Fuel = AZEAT_Indi_Engine_Control_Test.Fuel.Diesel constrainedby AZEAT_Indi_Engine_Control_Test.Fuel.SimpleFuel "Fuel type" annotation(
         choicesAllMatching,
      ...
      FluidPort co2_outlet(redeclare package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.CarbonDioxide, m_flow = -m_flow_CO2) if use_external_co2_sink annotation(
        Placement(transformation(extent = {{-10.0, -110.0}, {10.0, -90.0}}, rotation = 0.0, origin = {0.0, 0.0})));
    protected
...
// for mathematical stability , if constant efficiency is used this variable is not used in computation but it should be assigned with something for numerical balance
  ...
  model Tank "Tank model for gas storage"
    ...
    partial model Tank_base
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_TestFuel.Templates.SimpleFuel "Transported medium";
        Modelica.Units.SI.Pressure p "Pressure";
        flow Modelica.Units.SI.MassFlowRate m_flow "Mass flow rate";
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.compressedhydrogen "Transported Medium" annotation(
        choicesAllMatching);
    ...
    //EndRepositroy
    extends Tank_base(E_store = energyDensity_max*V, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.compressedhydrogen constrainedby AZEAT_Indi_Engine_Control_Test.Fuel.Templates.SimpleFuel);
    //Local Parameters
...
// Connectors
  ...
  model FuelCellEfficiency
    partial model Base
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test.Fuel.Hydrogen "Transported medium" annotation(
         choicesAllMatching);
...
//fuel parameter Generator_Fuel GEN 3
  ...
  // Part Battery
  AZEAT_Indi_Engine_Control_Test.BatteryDualControl battery1(eff_charge = battery_Eff_Charge, set_SOC_final_start_ = battery_Set_SOC_Final_Start, SOC_max = mCtrl_SOC_max, SOC_min = mCtrl_SOC_min, capacity = battery_Capacity, P_max = battery_P_max, SOC_start = battery_SOC_start) annotation(
    Placement(transformation(origin = {-60, -138}, extent = {{-18, -18}, {18, 18}})));
  // Part Electrical Untitlity
  AZEAT_Indi_Engine_Control_Test.Converter_ACDC converter_ACDC(efficiency = 1, V_ref_DC = 1, power_nominal = P_nominal, P_max = 10*P_nominal) "Inverter" annotation(
    Placement(transformation(origin = {144, -222}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.ElectricalGrid electricalGrid(power_nominal = P_nominal, V_ref = 1000) annotation(
    Placement(transformation(origin = {192, -224}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.ElectricLoad electricLoad(use_input = true, load_in = 1000) annotation(
    Placement(transformation(origin = {167, -201}, extent = {{11, -11}, {-11, 11}})));
  AZEAT_Indi_Engine_Control_Test.Transformer transformer(efficiency = 1, power_nominal = P_nominal, P_max = 10*P_nominal) annotation(
  ...
  AZEAT_Indi_Engine_Control_Test.IndividualEngineController individualEngineController(
  ...
  Modelica.Blocks.Sources.RealExpression LoadPower(y = electricLoad.P_load) annotation(
    Placement(transformation(origin = {-186, -206}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Sources.RealExpression BattSOC(y = battery1.SOC) annotation(
    Placement(transformation(origin = {-204, -206}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  AZEAT_Indi_Engine_Control_Test.Generator generator1(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator2(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator3(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator4(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator5(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator6(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator7(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator8(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator9(
  ...
  AZEAT_Indi_Engine_Control_Test.Generator generator10(
  ...
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort1(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 270}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort2(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 230}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort3(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 190}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort4(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 150}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort5(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 110}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort6(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, 30}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort7(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -10}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort8(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -50}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort9(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -90}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test.IdealTankSinglePort idealTankSinglePort10(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -130}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Sources.RealExpression genFuelFlow1(y = if gen1_is_on then generator1.outlet_fuel.m_flow else 0)  annotation(
    Placement(transformation(origin = {-490, -50}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Sources.RealExpression genFuelFlow2(y = if gen2_is_on then generator2.outlet_fuel.m_flow else 0)  annotation(
  ...
  Modelica.Blocks.Sources.RealExpression genFuelFlow8(y = if gen8_is_on then generator8.outlet_fuel.m_flow else 0)annotation(
    Placement(transformation(origin = {-490, -190}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Sources.RealExpression genFuelFlow10(y = if gen10_is_on then generator10.outlet_fuel.m_flow else 0) annotation(
    Placement(transformation(origin = {-490, -230}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Continuous.Integrator integrator1 annotation(
    Placement(transformation(origin = {-450, -50}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Continuous.Integrator integrator3 annotation(
    Placement(transformation(origin = {-450, -90}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Continuous.Integrator integrator4 annotation(
    Placement(transformation(origin = {-450, -110}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Continuous.Integrator integrator5 annotation(
    Placement(transformation(origin = {-450, -130}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Continuous.Integrator integrator8 annotation(
    Placement(transformation(origin = {-450, -190}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Continuous.Integrator integrator10 annotation(
    Placement(transformation(origin = {-450, -230}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump1 annotation(
    Placement(transformation(origin = {-410, -48}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump2 annotation(
  ...
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump3 annotation(
    Placement(transformation(origin = {-410, -90}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump4 annotation(
    Placement(transformation(origin = {-410, -110}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump5 annotation(
    Placement(transformation(origin = {-410, -130}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump7 annotation(
    Placement(transformation(origin = {-410, -170}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump8 annotation(
    Placement(transformation(origin = {-410, -190}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump10 annotation(
    Placement(transformation(origin = {-410, -230}, extent = {{-10, -10}, {10, 10}})));
...
equation
  ...
  connect(LoadPower.y, individualEngineController.P_load_1) annotation(
    Line(points = {{-186, -195}, {-186, -40.5}, {-187, -40.5}, {-187, -34.25}, {-185, -34.25}, {-185, -28}}, color = {0, 0, 127}));
  connect(BattSOC.y, individualEngineController.SOC_1) annotation(
    Line(points = {{-204, -195}, {-204, -111.5}, {-200, -111.5}, {-200, -28}}, color = {0, 0, 127}));
  ...
  connect(genFuelFlow1.y, integrator1.u) annotation(
    Line(points = {{-478, -50}, {-462, -50}}, color = {0, 0, 127}));
  connect(integrator1.y, realValueGenFuelConsump1.numberPort) annotation(
    Line(points = {{-438, -50}, {-422, -50}, {-422, -48}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end AZEAT_Indi_Engine_Control_Test;
