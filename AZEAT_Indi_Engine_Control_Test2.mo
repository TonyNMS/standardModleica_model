model AZEAT_Indi_Engine_Control_Test2
  //=============
  ...
  // External Model Repository for Local AZEAT_Indi_Engine_Control_Test2 Use
...
// before going into the loop, set the unmet to P_net for the first generartor
  ...
  IndividualEngineController.IndividualControllerCore3 individualControllerCore3(
      ...
      Placement(transformation(origin = {-37.1538, 42.9872}, extent = {{-36.8462, -39.9167}, {36.8462, 39.9167}})));
  equation
  ...
  model IdealTankSinglePort
    ...
    model TriplePortTank
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test2.Fuel.SimpleFuel "Transported medium";
      ...
      /*Fuel*/
      //Fuel model will be referenced From AZEAT_Indi_Engine_Control_Test2
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test2.Fuel.Templates.SimpleFuel "Transported medium" annotation(
         choicesAllMatching);
...
// Find how many units are required to run
  ...
  package Fuel
    ...
    package compressedhydrogen
      extends AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel(LHV = 120e6, rho = 26, rho_liq = 26, MolarMass = 1.00899e-3, Delta_h_evap = 2.01588*1e-3);
  ...
  model Generator
    ...
    model Generator_Base
      ...
      replaceable package Fuel = AZEAT_Indi_Engine_Control_Test2.Fuel.Diesel constrainedby AZEAT_Indi_Engine_Control_Test2.Fuel.SimpleFuel "Fuel type" annotation(
         choicesAllMatching,
      ...
      FluidPort co2_outlet(redeclare package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.CarbonDioxide, m_flow = -m_flow_CO2) if use_external_co2_sink annotation(
        Placement(transformation(extent = {{-10.0, -110.0}, {10.0, -90.0}}, rotation = 0.0, origin = {0.0, 0.0})));
    protected
...
// for mathematical stability , if constant efficiency is used this variable is not used in computation but it should be assigned with something for numerical balance
  ...
  model Tank "Tank model for gas storage"
    ...
    partial model Tank_base
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test2Fuel.Templates.SimpleFuel "Transported medium";
        Modelica.Units.SI.Pressure p "Pressure";
        flow Modelica.Units.SI.MassFlowRate m_flow "Mass flow rate";
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.compressedhydrogen "Transported Medium" annotation(
        choicesAllMatching);
    ...
    //EndRepositroy
    extends Tank_base(E_store = energyDensity_max*V, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.compressedhydrogen constrainedby AZEAT_Indi_Engine_Control_Test2.Fuel.Templates.SimpleFuel);
    //Local Parameters
...
// Connectors
  ...
  model FuelCellEfficiency
    partial model Base
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test2.Fuel.Hydrogen "Transported medium" annotation(
         choicesAllMatching);
...
//fuel parameter Generator_Fuel GEN 3
  ...
  parameter Real battery_P_max = 0.1; //93240
  ...
  parameter Real BSFC_Curve_2[:, 2] = [80, 197.91; 160, 189.97; 240, 183.23; 320, 177.71; 400, 173.40; 480, 170.30; 560, 168.42; 640, 167.74; 720, 168.28; 800, 170.03];
  ...
  // Part Battery
  AZEAT_Indi_Engine_Control_Test2.BatteryDualControl battery1(eff_charge = battery_Eff_Charge, set_SOC_final_start_ = battery_Set_SOC_Final_Start, SOC_max = mCtrl_SOC_max, SOC_min = mCtrl_SOC_min, capacity = battery_Capacity, P_max = battery_P_max, SOC_start = battery_SOC_start) annotation(
    Placement(transformation(origin = {-60, -138}, extent = {{-18, -18}, {18, 18}})));
  // Part Electrical Untitlity
  AZEAT_Indi_Engine_Control_Test2.Converter_ACDC converter_ACDC(efficiency = 1, V_ref_DC = 1, power_nominal = P_nominal, P_max = 10*P_nominal) "Inverter" annotation(
    Placement(transformation(origin = {144, -222}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.ElectricalGrid electricalGrid(power_nominal = P_nominal, V_ref = 1000) annotation(
    Placement(transformation(origin = {192, -224}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.ElectricLoad electricLoad(use_input = true, load_in = 1000) annotation(
    Placement(transformation(origin = {167, -201}, extent = {{11, -11}, {-11, 11}})));
  AZEAT_Indi_Engine_Control_Test2.Transformer transformer(efficiency = 1, power_nominal = P_nominal, P_max = 10*P_nominal) annotation(
  ...
  AZEAT_Indi_Engine_Control_Test2.IndividualEngineController individualEngineController(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator1(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator2(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator3(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator4(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator5(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator6(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator7(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator8(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator9(
  ...
  AZEAT_Indi_Engine_Control_Test2.Generator generator10(
  ...
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort1(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 270}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort2(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 230}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort3(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 190}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort4(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 150}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort5(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel) annotation(
    Placement(transformation(origin = {90, 110}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort6(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, 30}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort7(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -10}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort8(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -50}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort9(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel)  annotation(
    Placement(transformation(origin = {110, -90}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test2.IdealTankSinglePort idealTankSinglePort10(m_content_max = idealTank_TankcontentDiesel, m_content_start = idealTank_TankcontentDieselStart, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test2.Fuel.MethanolFuel)  annotation(
  ...
  Modelica.Blocks.Sources.RealExpression genFuelFlow10(y = if gen10_is_on then generator10.outlet_fuel.m_flow else 0) annotation(
    Placement(transformation(origin = {-490, -246}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Interaction.Show.RealValue realValueGenFuelConsump11 annotation(
...
equation
  ...
  connect(BattSOC.y, individualEngineController.SOC_1) annotation(
    Line(points = {{-208, -197}, {-208, -111.5}, {-200, -111.5}, {-200, -28}}, color = {0, 0, 127}));
  ...
  connect(integrator11.y, realValueGenFuelConsump11.numberPort) annotation(
  ...
  connect(genFuelFlow2.y, integrator2.u) annotation(
    Line(points = {{-478, -70}, {-462, -70}}, color = {0, 0, 127}));
  connect(integrator2.y, realValueGenFuelConsump2.numberPort) annotation(
    Line(points = {{-438, -70}, {-422, -70}}, color = {0, 0, 127}));
  ...
  annotation(
    ...
    uses(Modelica(version = "4.0.0")),
    Diagram(coordinateSystem(extent = {{-520, 320}, {320, -300}})),
    version = "",
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end AZEAT_Indi_Engine_Control_Test2;
