model AZEAT_Indi_Engine_Control_Test_7
  //=============
...
// before going into the loop, set the unmet to P_net for the first generartor
    ...
    /*
                        ...
                        */
    Modelica.Blocks.Sources.RealExpression PowertrainChargingPwr(y = individualControllerCore7.P_batt_charge_request) annotation(
  ...
  IndividualEngineController.IndividualControllerCore7 individualControllerCore7(
  gen_1_exist = controller_gen_1_exist, gen_2_exist = controller_gen_2_exist, 
                                gen_3_exist = controller_gen_3_exist, gen_4_exist = controller_gen_4_exist, 
                                gen_5_exist = controller_gen_5_exist, gen_6_exist = controller_gen_6_exist, 
                                gen_7_exist = controller_gen_7_exist, gen_8_exist = controller_gen_8_exist, 
      ...
      Placement(transformation(origin = {-31.5385, 39.1282}, extent = {{-45.5385, -49.3333}, {45.5385, 49.3333}})));
  equation
  ...
  connect(gen_1_controller_optim_upper, individualControllerCore7.P_gen_1_Optim_Upper) annotation(
      Line(points = {{-110, 90}, {-88, 90}, {-88, 73}, {-73, 73}}, color = {0, 0, 127}));
  connect(gen_1_controller_optim_lower, individualControllerCore7.P_gen_1_Optim_Lower) annotation(
      Line(points = {{-110, 70}, {-90.5, 70}, {-90.5, 66}, {-73, 66}}, color = {0, 0, 127}));
  connect(gen_2_controller_optim_upper, individualControllerCore7.P_gen_2_Optim_Upper) annotation(
      Line(points = {{-110, 50}, {-90, 50}, {-90, 58}, {-73, 58}}, color = {0, 0, 127}));
  connect(gen_2_controller_optim_lower, individualControllerCore7.P_gen_2_Optim_Lower) annotation(
      Line(points = {{-110, 30}, {-86, 30}, {-86, 51}, {-73, 51}}, color = {0, 0, 127}));
  connect(gen_3_controller_optim_upper, individualControllerCore7.P_gen_3_Optim_Upper) annotation(
      Line(points = {{-110, 10}, {-90, 10}, {-90, 43}, {-73, 43}}, color = {0, 0, 127}));
  connect(gen_3_controller_optim_lower, individualControllerCore7.P_gen_3_Optim_Lower) annotation(
      Line(points = {{-110, -10}, {-94, -10}, {-94, 35}, {-73, 35}}, color = {0, 0, 127}));
  connect(gen_4_controller_optim_upper, individualControllerCore7.P_gen_4_Optim_Upper) annotation(
      Line(points = {{-110, -30}, {-88, -30}, {-88, 28}, {-73, 28}}, color = {0, 0, 127}));
  connect(gen_4_controller_optim_lower, individualControllerCore7.P_gen_4_Optim_Lower) annotation(
      Line(points = {{-110, -50}, {-84, -50}, {-84, 20}, {-73, 20}}, color = {0, 0, 127}));
  connect(gen_5_controller_optim_upper, individualControllerCore7.P_gen_5_Optim_Upper) annotation(
      Line(points = {{-110, -70}, {-92, -70}, {-92, 13}, {-73, 13}}, color = {0, 0, 127}));
  connect(gen_5_controller_optim_lower, individualControllerCore7.P_gen_5_Optim_Lower) annotation(
      Line(points = {{-110, -90}, {-90, -90}, {-90, 5}, {-73, 5}}, color = {0, 0, 127}));
  connect(individualControllerCore7.P_load_1, P_load_1) annotation(
      Line(points = {{-65, -3}, {-65, -1}, {-66, -1}, {-66, -114}}, color = {0, 0, 127}));
  connect(SOC_1, individualControllerCore7.SOC_1) annotation(
      Line(points = {{-92, -120}, {-94, -120}, {-94, -28}, {-57, -28}, {-57, -3}}, color = {0, 0, 127}));
  connect(genMinBSFC1, individualControllerCore7.genMostEffPwr1) annotation(
      Line(points = {{-50, -106}, {-50, -12}, {-35, -12}, {-35, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC2, individualControllerCore7.genMostEffPwr2) annotation(
      Line(points = {{-42, -106}, {-42, -6}, {-32, -6}, {-32, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC3, individualControllerCore7.genMostEffPwr3) annotation(
      Line(points = {{-34, -106}, {-34, -10}, {-28, -10}, {-28, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC4, individualControllerCore7.genMostEffPwr4) annotation(
      Line(points = {{-26, -106}, {-26, -48.5}, {-24, -48.5}, {-24, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC5, individualControllerCore7.genMostEffPwr5) annotation(
      Line(points = {{-18, -106}, {-18, -50.5}, {-20, -50.5}, {-20, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC6, individualControllerCore7.genMostEffPwr6) annotation(
      Line(points = {{-10, -106}, {-10, -6}, {-16, -6}, {-16, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC7, individualControllerCore7.genMostEffPwr7) annotation(
      Line(points = {{-2, -106}, {-2, -14}, {-13, -14}, {-13, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC8, individualControllerCore7.genMostEffPwr8) annotation(
      Line(points = {{6, -106}, {6, -84}, {-14, -84}, {-14, -8}, {-9, -8}, {-9, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC9, individualControllerCore7.genMostEffPwr9) annotation(
      Line(points = {{14, -106}, {14, -80}, {-6, -80}, {-6, -8}, {-5, -8}, {-5, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC10, individualControllerCore7.genMostEffPwr10) annotation(
      Line(points = {{22, -106}, {22, -90}, {-8, -90}, {-8, -12}, {-1, -12}, {-1, -1}}, color = {0, 0, 127}));
  connect(individualControllerCore7.P_battery_1, gainCharingMin.u) annotation(
      Line(points = {{10, -3}, {10, -4}, {29, -4}}, color = {0, 0, 127}));
  connect(gen_6_controller_optim_upper, individualControllerCore7.P_gen_6_Optim_Upper) annotation(
      Line(points = {{-90, 110}, {-90, 96}, {-66, 96}, {-66, 81}}, color = {0, 0, 127}));
  connect(gen_6_controller_optim_lower, individualControllerCore7.P_gen_6_Optim_Lower) annotation(
      Line(points = {{-70, 110}, {-70, 94}, {-58, 94}, {-58, 81}}, color = {0, 0, 127}));
  connect(gen_7_controller_optim_upper, individualControllerCore7.P_gen_7_Optim_Upper) annotation(
      Line(points = {{-50, 110}, {-50, 97}, {-51, 97}, {-51, 81}}, color = {0, 0, 127}));
  connect(gen_7_controller_optim_lower, individualControllerCore7.P_gen_7_Optim_Lower) annotation(
      Line(points = {{-30, 110}, {-30, 96}, {-43, 96}, {-43, 81}}, color = {0, 0, 127}));
  connect(gen_8_controller_optim_upper, individualControllerCore7.P_gen_8_Optim_Upper) annotation(
      Line(points = {{-10, 110}, {-10, 94}, {-35, 94}, {-35, 81}}, color = {0, 0, 127}));
  connect(gen_8_controller_optim_lower, individualControllerCore7.P_gen_8_Optim_Lower) annotation(
      Line(points = {{10, 110}, {10, 96}, {-28, 96}, {-28, 81}}, color = {0, 0, 127}));
  connect(gen_9_controller_optim_upper, individualControllerCore7.P_gen_9_Optim_Upper) annotation(
      Line(points = {{30, 110}, {30, 92}, {-20, 92}, {-20, 81}}, color = {0, 0, 127}));
  connect(gen_9_controller_optim_lower, individualControllerCore7.P_gen_9_Optim_Lower) annotation(
      Line(points = {{50, 110}, {50, 94}, {-6, 94}, {-6, 90}, {-13, 90}, {-13, 81}}, color = {0, 0, 127}));
  connect(gen_10_controller_optim_upper, individualControllerCore7.P_gen_10_Optim_Upper) annotation(
      Line(points = {{70, 110}, {70, 98}, {-5, 98}, {-5, 81}}, color = {0, 0, 127}));
  connect(gen_10_controller_optim_lower, individualControllerCore7.P_gen_10_Optim_Lower) annotation(
      Line(points = {{90, 110}, {90, 90}, {3, 90}, {3, 81}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen1_output, generator_1_controller_output) annotation(
      Line(points = {{10, 73}, {58, 73}, {58, 90}, {110, 90}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen2_output, generator_2_controller_output) annotation(
      Line(points = {{10, 66}, {61, 66}, {61, 70}, {110, 70}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen3_output, generator_3_controller_output) annotation(
      Line(points = {{10, 58}, {54, 58}, {54, 50}, {110, 50}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen4_output, generator_4_controller_output) annotation(
      Line(points = {{10, 51}, {36, 51}, {36, 30}, {110, 30}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen5_output, generator_5_controller_output) annotation(
      Line(points = {{10, 43}, {56, 43}, {56, 10}, {110, 10}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen6_output, generator_6_controller_output) annotation(
      Line(points = {{10, 35}, {48, 35}, {48, 18}, {70, 18}, {70, -10}, {110, -10}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen7_output, generator_7_controller_output) annotation(
      Line(points = {{10, 28}, {64, 28}, {64, -32}, {110, -32}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen8_output, generator_8_controller_output) annotation(
      Line(points = {{10, 20}, {56, 20}, {56, -50}, {110, -50}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen9_output, generator_9_controller_output) annotation(
      Line(points = {{10, 13}, {74, 13}, {74, -70}, {110, -70}}, color = {0, 0, 127}));
  connect(individualControllerCore7.gen10_output, generator_10_controller_output) annotation(
      Line(points = {{10, 5}, {60, 5}, {60, -90}, {110, -90}}, color = {0, 0, 127}));
    annotation(
      Diagram,
  ...
  model IdealTankSinglePort
    ...
    model TriplePortTank
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_7.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_7.Fuel.SimpleFuel "Transported medium";
      ...
      /*Fuel*/
      //Fuel model will be referenced From AZEAT_Indi_Engine_Control_Test_7
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_7.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_7.Fuel.Templates.SimpleFuel "Transported medium" annotation(
         choicesAllMatching);
...
// Find how many units are required to run
  ...
  package Fuel
    ...
    package compressedhydrogen
      extends AZEAT_Indi_Engine_Control_Test_7.Fuel.MethanolFuel(LHV = 120e6, rho = 26, rho_liq = 26, MolarMass = 1.00899e-3, Delta_h_evap = 2.01588*1e-3);
  ...
  model Generator
    ...
    model Generator_Base
      ...
      replaceable package Fuel = AZEAT_Indi_Engine_Control_Test_7.Fuel.Diesel constrainedby AZEAT_Indi_Engine_Control_Test_7.Fuel.SimpleFuel "Fuel type" annotation(
         choicesAllMatching,
      ...
      FluidPort co2_outlet(redeclare package Medium = AZEAT_Indi_Engine_Control_Test_7.Fuel.CarbonDioxide, m_flow = -m_flow_CO2) if use_external_co2_sink annotation(
        Placement(transformation(extent = {{-10.0, -110.0}, {10.0, -90.0}}, rotation = 0.0, origin = {0.0, 0.0})));
    protected
...
// for mathematical stability , if constant efficiency is used this variable is not used in computation but it should be assigned with something for numerical balance
  ...
  model Tank "Tank model for gas storage"
    ...
    partial model Tank_base
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_7.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_7Fuel.Templates.SimpleFuel "Transported medium";
        Modelica.Units.SI.Pressure p "Pressure";
        flow Modelica.Units.SI.MassFlowRate m_flow "Mass flow rate";
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_7.Fuel.compressedhydrogen "Transported Medium" annotation(
        choicesAllMatching);
    ...
    //EndRepositroy
    extends Tank_base(E_store = energyDensity_max*V, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_7.Fuel.compressedhydrogen constrainedby AZEAT_Indi_Engine_Control_Test_7.Fuel.Templates.SimpleFuel);
    //Local Parameters
...
// Connectors
  ...
  model FuelCellEfficiency
    partial model Base
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_7.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_7.Fuel.Hydrogen "Transported medium" annotation(
         choicesAllMatching);
...
// Summary
  ...
  parameter Real battery_Capacity = 2.239e+8*3;
  parameter Real battery_P_max = 93240*3; //93240
  ...
  // Part Battery
  AZEAT_Indi_Engine_Control_Test_7.BatteryDualControl battery1(eff_charge = battery_Eff_Charge, set_SOC_final_start_ = battery_Set_SOC_Final_Start, SOC_max = mCtrl_SOC_max, SOC_min = mCtrl_SOC_min, capacity = battery_Capacity, P_max = battery_P_max, SOC_start = battery_SOC_start) annotation(
    Placement(transformation(origin = {-60, -138}, extent = {{-18, -18}, {18, 18}})));
  // Part Electrical Untitlity
  AZEAT_Indi_Engine_Control_Test_7.Converter_ACDC converter_ACDC(efficiency = 1, V_ref_DC = 1, power_nominal = P_nominal, P_max = 10*P_nominal) "Inverter" annotation(
    Placement(transformation(origin = {144, -222}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_7.ElectricalGrid electricalGrid(power_nominal = P_nominal, V_ref = 1000) annotation(
    Placement(transformation(origin = {192, -224}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_7.ElectricLoad electricLoad(use_input = true, load_in = 1000) annotation(
    Placement(transformation(origin = {167, -201}, extent = {{11, -11}, {-11, 11}})));
  AZEAT_Indi_Engine_Control_Test_7.Transformer transformer(efficiency = 1, power_nominal = P_nominal, P_max = 10*P_nominal) annotation(
  ...
  AZEAT_Indi_Engine_Control_Test_7.FuelUsageTrapezoidSampled fuelUsageTrapezoidSampled annotation(
...
equation
  ...
  annotation(
    ...
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end AZEAT_Indi_Engine_Control_Test_7;
