model AZEAT_Indi_Engine_Control_Test_9
  //=============
...
// before going into the loop, set the unmet to P_net for the first generartor
    ...
    /*
                        ...
                        */
    Modelica.Blocks.Sources.RealExpression PowertrainChargingPwr(y = individualControllerCore9.P_batt_charge_request) annotation(
  ...
  IndividualEngineController.IndividualControllerCore9 individualControllerCore9(
                                gen_1_exist = controller_gen_1_exist, gen_2_exist = controller_gen_2_exist, 
                                gen_3_exist = controller_gen_3_exist, gen_4_exist = controller_gen_4_exist, 
                                gen_5_exist = controller_gen_5_exist, gen_6_exist = controller_gen_6_exist, 
                                gen_7_exist = controller_gen_7_exist, gen_8_exist = controller_gen_8_exist, 
      ...
      Placement(transformation(origin = {-36, 39.5}, extent = {{-44, -47.6667}, {44, 47.6667}})));
  equation
  ...
  connect(gen_1_controller_optim_upper, individualControllerCore9.P_gen_1_Optim_Upper) annotation(
      Line(points = {{-110, 90}, {-90, 90}, {-90, 72.5}, {-76, 72.5}}, color = {0, 0, 127}));
  connect(gen_1_controller_optim_lower, individualControllerCore9.P_gen_1_Optim_Lower) annotation(
      Line(points = {{-110, 70}, {-94, 70}, {-94, 65}, {-76, 65}}, color = {0, 0, 127}));
  connect(gen_2_controller_optim_upper, individualControllerCore9.P_gen_2_Optim_Upper) annotation(
      Line(points = {{-110, 50}, {-86, 50}, {-86, 58}, {-76, 58}}, color = {0, 0, 127}));
  connect(gen_2_controller_optim_lower, individualControllerCore9.P_gen_2_Optim_Lower) annotation(
      Line(points = {{-110, 30}, {-90, 30}, {-90, 50.5}, {-76, 50.5}}, color = {0, 0, 127}));
  connect(gen_3_controller_optim_upper, individualControllerCore9.P_gen_3_Optim_Upper) annotation(
      Line(points = {{-110, 10}, {-92, 10}, {-92, 43}, {-76, 43}}, color = {0, 0, 127}));
  connect(gen_3_controller_optim_lower, individualControllerCore9.P_gen_3_Optim_Lower) annotation(
      Line(points = {{-110, -10}, {-88, -10}, {-88, 36}, {-76, 36}}, color = {0, 0, 127}));
  connect(gen_4_controller_optim_upper, individualControllerCore9.P_gen_4_Optim_Upper) annotation(
      Line(points = {{-110, -30}, {-90, -30}, {-90, 28.5}, {-76, 28.5}}, color = {0, 0, 127}));
  connect(gen_4_controller_optim_lower, individualControllerCore9.P_gen_4_Optim_Lower) annotation(
      Line(points = {{-110, -50}, {-86, -50}, {-86, 21}, {-76, 21}}, color = {0, 0, 127}));
  connect(gen_5_controller_optim_upper, individualControllerCore9.P_gen_5_Optim_Upper) annotation(
      Line(points = {{-110, -70}, {-96, -70}, {-96, 14}, {-76, 14}}, color = {0, 0, 127}));
  connect(gen_5_controller_optim_lower, individualControllerCore9.P_gen_5_Optim_Lower) annotation(
      Line(points = {{-110, -90}, {-90, -90}, {-90, -56}, {-94, -56}, {-94, 6.5}, {-76, 6.5}}, color = {0, 0, 127}));
  connect(P_load_1, individualControllerCore9.P_load_1) annotation(
      Line(points = {{-66, -114}, {-66, -57}, {-68, -57}, {-68, -1}}, color = {0, 0, 127}));
  connect(SOC_1, individualControllerCore9.SOC_1) annotation(
      Line(points = {{-92, -120}, {-92, -66}, {-61, -66}, {-61, -1}}, color = {0, 0, 127}));
  connect(genMinBSFC1, individualControllerCore9.genMostEffPwr1) annotation(
      Line(points = {{-50, -106}, {-50, -10}, {-40, -10}, {-40, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC2, individualControllerCore9.genMostEffPwr2) annotation(
      Line(points = {{-42, -106}, {-42, -14}, {-36, -14}, {-36, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC3, individualControllerCore9.genMostEffPwr3) annotation(
      Line(points = {{-34, -106}, {-34, -53.5}, {-32, -53.5}, {-32, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC4, individualControllerCore9.genMostEffPwr4) annotation(
      Line(points = {{-26, -106}, {-26, -53}, {-29, -53}, {-29, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC5, individualControllerCore9.genMostEffPwr5) annotation(
      Line(points = {{-18, -106}, {-18, -6}, {-25, -6}, {-25, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC6, individualControllerCore9.genMostEffPwr6) annotation(
      Line(points = {{-10, -106}, {-10, -26}, {-21, -26}, {-21, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC7, individualControllerCore9.genMostEffPwr7) annotation(
      Line(points = {{-2, -106}, {-4, -106}, {-4, -86}, {-18, -86}, {-18, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC8, individualControllerCore9.genMostEffPwr8) annotation(
      Line(points = {{6, -106}, {6, -76}, {-14, -76}, {-14, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC9, individualControllerCore9.genMostEffPwr9) annotation(
      Line(points = {{14, -106}, {14, -82}, {-10, -82}, {-10, 1}}, color = {0, 0, 127}));
  connect(genMinBSFC10, individualControllerCore9.genMostEffPwr10) annotation(
      Line(points = {{22, -106}, {22, -78}, {-7, -78}, {-7, 1}}, color = {0, 0, 127}));
  connect(gen_6_controller_optim_upper, individualControllerCore9.P_gen_6_Optim_Upper) annotation(
      Line(points = {{-90, 110}, {-90, 92}, {-94, 92}, {-94, 88}, {-69, 88}, {-69, 80}}, color = {0, 0, 127}));
  connect(gen_6_controller_optim_lower, individualControllerCore9.P_gen_6_Optim_Lower) annotation(
      Line(points = {{-70, 110}, {-70, 86}, {-62, 86}, {-62, 80}}, color = {0, 0, 127}));
  connect(gen_7_controller_optim_upper, individualControllerCore9.P_gen_7_Optim_Upper) annotation(
      Line(points = {{-50, 110}, {-50, 92}, {-54, 92}, {-54, 80}}, color = {0, 0, 127}));
  connect(gen_7_controller_optim_lower, individualControllerCore9.P_gen_7_Optim_Lower) annotation(
      Line(points = {{-30, 110}, {-30, 94}, {-47, 94}, {-47, 80}}, color = {0, 0, 127}));
  connect(gen_8_controller_optim_upper, individualControllerCore9.P_gen_8_Optim_Upper) annotation(
      Line(points = {{-10, 110}, {-10, 90}, {-40, 90}, {-40, 80}}, color = {0, 0, 127}));
  connect(gen_8_controller_optim_lower, individualControllerCore9.P_gen_8_Optim_Lower) annotation(
      Line(points = {{10, 110}, {10, 92}, {-32, 92}, {-32, 80}}, color = {0, 0, 127}));
  connect(gen_9_controller_optim_upper, individualControllerCore9.P_gen_9_Optim_Upper) annotation(
      Line(points = {{30, 110}, {30, 88}, {-25, 88}, {-25, 80}}, color = {0, 0, 127}));
  connect(gen_9_controller_optim_lower, individualControllerCore9.P_gen_9_Optim_Lower) annotation(
      Line(points = {{50, 110}, {50, 86}, {-18, 86}, {-18, 80}}, color = {0, 0, 127}));
  connect(gen_10_controller_optim_upper, individualControllerCore9.P_gen_10_Optim_Upper) annotation(
      Line(points = {{70, 110}, {70, 90}, {-10, 90}, {-10, 80}}, color = {0, 0, 127}));
  connect(gen_10_controller_optim_lower, individualControllerCore9.P_gen_10_Optim_Lower) annotation(
      Line(points = {{90, 110}, {90, 94}, {-3, 94}, {-3, 80}}, color = {0, 0, 127}));
  connect(individualControllerCore9.P_battery_1, gainCharingMin.u) annotation(
      Line(points = {{4, 0}, {12, 0}, {12, -4}, {30, -4}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen1_output, generator_1_controller_output) annotation(
      Line(points = {{4, 72}, {72, 72}, {72, 90}, {110, 90}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen2_output, generator_2_controller_output) annotation(
      Line(points = {{4, 66}, {86, 66}, {86, 70}, {110, 70}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen3_output, generator_3_controller_output) annotation(
      Line(points = {{4, 58}, {78, 58}, {78, 50}, {110, 50}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen4_output, generator_4_controller_output) annotation(
      Line(points = {{4, 50}, {74, 50}, {74, 30}, {110, 30}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen5_output, generator_5_controller_output) annotation(
      Line(points = {{4, 44}, {78, 44}, {78, 10}, {110, 10}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen6_output, generator_6_controller_output) annotation(
      Line(points = {{4, 36}, {76, 36}, {76, -10}, {110, -10}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen7_output, generator_7_controller_output) annotation(
      Line(points = {{4, 28}, {68, 28}, {68, -32}, {110, -32}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen8_output, generator_8_controller_output) annotation(
      Line(points = {{4, 22}, {64, 22}, {64, -50}, {110, -50}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen9_output, generator_9_controller_output) annotation(
      Line(points = {{4, 14}, {60, 14}, {60, -70}, {110, -70}}, color = {0, 0, 127}));
  connect(individualControllerCore9.gen10_output, generator_10_controller_output) annotation(
      Line(points = {{4, 6}, {74, 6}, {74, -90}, {110, -90}}, color = {0, 0, 127}));
    annotation(
      Diagram,
  ...
  model IdealTankSinglePort
    ...
    model TriplePortTank
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_9.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_9.Fuel.SimpleFuel "Transported medium";
      ...
      /*Fuel*/
      //Fuel model will be referenced From AZEAT_Indi_Engine_Control_Test_9
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_9.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_9.Fuel.Templates.SimpleFuel "Transported medium" annotation(
         choicesAllMatching);
...
// Find how many units are required to run
  ...
  package Fuel
    ...
    package compressedhydrogen
      extends AZEAT_Indi_Engine_Control_Test_9.Fuel.MethanolFuel(LHV = 120e6, rho = 26, rho_liq = 26, MolarMass = 1.00899e-3, Delta_h_evap = 2.01588*1e-3);
  ...
  model Generator
    ...
    model Generator_Base
      ...
      replaceable package Fuel = AZEAT_Indi_Engine_Control_Test_9.Fuel.Diesel constrainedby AZEAT_Indi_Engine_Control_Test_9.Fuel.SimpleFuel "Fuel type" annotation(
         choicesAllMatching,
      ...
      FluidPort co2_outlet(redeclare package Medium = AZEAT_Indi_Engine_Control_Test_9.Fuel.CarbonDioxide, m_flow = -m_flow_CO2) if use_external_co2_sink annotation(
        Placement(transformation(extent = {{-10.0, -110.0}, {10.0, -90.0}}, rotation = 0.0, origin = {0.0, 0.0})));
    protected
...
// for mathematical stability , if constant efficiency is used this variable is not used in computation but it should be assigned with something for numerical balance
  ...
  model Tank "Tank model for gas storage"
    ...
    partial model Tank_base
      ...
      connector FluidPort "Fluid port for low fidelity models in microgrid components"
        replaceable package Medium = AZEAT_Indi_Engine_Control_Test_9.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_9Fuel.Templates.SimpleFuel "Transported medium";
        Modelica.Units.SI.Pressure p "Pressure";
        flow Modelica.Units.SI.MassFlowRate m_flow "Mass flow rate";
        annotation(
          Icon(coordinateSystem(preserveAspectRatio = false), graphics = {Ellipse(extent = {{-100, 100}, {100, -100}}, lineColor = {28, 108, 200}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_9.Fuel.compressedhydrogen "Transported Medium" annotation(
        choicesAllMatching);
    ...
    //EndRepositroy
    extends Tank_base(E_store = energyDensity_max*V, redeclare replaceable package Medium = AZEAT_Indi_Engine_Control_Test_9.Fuel.compressedhydrogen constrainedby AZEAT_Indi_Engine_Control_Test_9.Fuel.Templates.SimpleFuel);
    //Local Parameters
...
// Connectors
  ...
  model FuelCellEfficiency
    partial model Base
      ...
      replaceable package Medium = AZEAT_Indi_Engine_Control_Test_9.Fuel.Hydrogen constrainedby AZEAT_Indi_Engine_Control_Test_9.Fuel.Hydrogen "Transported medium" annotation(
         choicesAllMatching);
...
// Summary
  ...
  // Part Battery
  AZEAT_Indi_Engine_Control_Test_9.BatteryDualControl battery1(eff_charge = battery_Eff_Charge, set_SOC_final_start_ = battery_Set_SOC_Final_Start, SOC_max = mCtrl_SOC_max, SOC_min = mCtrl_SOC_min, capacity = battery_Capacity, P_max = battery_P_max, SOC_start = battery_SOC_start) annotation(
    Placement(transformation(origin = {-60, -138}, extent = {{-18, -18}, {18, 18}})));
  // Part Electrical Untitlity
  AZEAT_Indi_Engine_Control_Test_9.Converter_ACDC converter_ACDC(efficiency = 1, V_ref_DC = 1, power_nominal = P_nominal, P_max = 10*P_nominal) "Inverter" annotation(
    Placement(transformation(origin = {144, -222}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_9.ElectricalGrid electricalGrid(power_nominal = P_nominal, V_ref = 1000) annotation(
    Placement(transformation(origin = {192, -224}, extent = {{-10, -10}, {10, 10}})));
  AZEAT_Indi_Engine_Control_Test_9.ElectricLoad electricLoad(use_input = true, load_in = 1000) annotation(
    Placement(transformation(origin = {167, -201}, extent = {{11, -11}, {-11, 11}})));
  AZEAT_Indi_Engine_Control_Test_9.Transformer transformer(efficiency = 1, power_nominal = P_nominal, P_max = 10*P_nominal) annotation(
  ...
  AZEAT_Indi_Engine_Control_Test_9.FuelUsageTrapezoidSampled fuelUsageTrapezoidSampled annotation(
...
equation
  ...
  annotation(
    ...
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
end AZEAT_Indi_Engine_Control_Test_9;
